...
import { PAIRS } from "./lib/positionCalc";
  ...
  return (
    <div className="p-4 md:p-8 max-w-2xl mx-auto space-y-5">
      <Card className="p-5 md:p-6">
        ...
        <p className="text-xs text-[var(--text-muted)] mb-5 leading-relaxed">Work out what a pip is worth, or measure pip distance between two prices.</p>
