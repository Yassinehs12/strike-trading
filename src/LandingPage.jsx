...
const FEATURES = [
  ...
  { tag: "Discipline", icon: NotebookPen, title: "Daily Market Plan", desc: "Write your bias, key levels, and setups before the session opens — with a fill-progress tracker and a running history of every past plan, so you trade the plan instead of the moment." },
