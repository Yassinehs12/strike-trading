...
const tradeFromDB = (r) => ({
  ...
  screenshots: (r.screenshots && r.screenshots.length ? r.screenshots : (r.screenshot ? [r.screenshot] : [])),
  notes: r.notes ?? "",
...
const tradeToDB = (t, userId) => ({
  ...
  status: t.status,
  pnl: t.pnl,
  risk_amount: t.riskAmount === "" || t.riskAmount == null ? null : Number(t.riskAmount),
  holding_minutes: t.holdingMinutes || 0,
  challenge_id: t.challengeId || null,
  account_id: t.accountId || null,
  screenshot: (t.screenshots && t.screenshots[0]) || t.screenshot || null,
